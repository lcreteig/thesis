...
apa_table(apa_aov_T2.given.T1$table, caption = "Repeated measures ANOVA on T2|T1 accuracy", font_size = "small")
```
...
apa_table(apa_aov_T1$table, caption = "Repeated measures ANOVA on T1 accuracy", font_size = "small")
```
