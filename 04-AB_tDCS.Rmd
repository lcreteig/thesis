...
```{r fig-group, fig.cap='(ref:caption-fig-group)', results='show', out.width = out_width}
...
T2_df %>%
  ...
  footnote(general = 'Values are "Mean (SD)"', general_title = "")
}
```
...
apa_table(apa_aov_T2.given.T1$table, caption = "Repeated measures ANOVA on T2|T1 accuracy", font_size = "small", longtable = TRUE)
```
...
apa_table(apa_aov_T1$table, caption = "Repeated measures ANOVA on T1 accuracy", font_size = "small", longtable = TRUE)
```
...
```{r fig-corr, fig.cap='(ref:caption-fig-corr)', results='show', out.width = out_width}
...
```{r fig-rep-estimate, fig.cap='(ref:caption-fig-rep-estimate)', results='show', out.width = out_width}
