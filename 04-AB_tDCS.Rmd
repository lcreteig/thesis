...
```{r fig-group, fig.cap='(ref:caption-fig-group)', results='show', out.width="5.5in"}
...
```{r fig-corr, fig.cap='(ref:caption-fig-corr)', results='show', out.width="5.5in"}
...
```{r fig-rep-estimate, fig.cap='(ref:caption-fig-rep-estimate)', results='show', out.width="5.5in"}
