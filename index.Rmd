...
papaja::create_bib(c('base', 'bookdown', 'knitr', 'rmarkdown', # general
                     'tidyverse', 'cowplot', 'broom', 'rogme', 'ez', 'BayesFactor' # chapter 2
                     ), file = '/Volumes/psychology$/Researchers/reteig/thesis/r-packages.bib', append = FALSE)
```
