...
```{r sacc-tDCS-procedure, fig.cap='(ref:caption-figure-sacc-tDCS-procedure)', results='show', out.width = out_width}
...
```{r FEF, fig.cap='(ref:caption-figure-FEF)', results='show', out.width = out_width}
knitr::include_graphics("sacc_tDCS_files/figures/figure_3_FEF.png")
```
...
```{r fig-latency, fig.cap='(ref:caption-figure-latency)', results='show', out.width = out_width}
...
```{r quantiles, fig.cap='(ref:caption-figure-quantiles)', results='show', out.width = out_width}
...
```{r fig-deviation, fig.cap='(ref:caption-figure-deviation)', results='show', out.width = out_width}
...
```{r fig-variability, fig.cap='(ref:caption-figure-variability)', results='show', out.width = out_width}
