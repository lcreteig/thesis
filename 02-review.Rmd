...
pander(tbl_other, split.tables = Inf, justify = 'left',  missing = '',
       split.cells = c(20,1,1,25,4,10,7,15,70),
...
In conclusion, anodal tDCS over the right parietal cortex may speed up visual search, while cathodal stimulation may slow it down. However, results are inconsistent, may differ per hemifield, and appear restricted to particular aspects of visual search (e.g., salient distractors). Anodal stimulation over the right inferior frontal cortex has consistently been shown to speed up object detection. Perhaps this success can be attributed to the challenging nature of the task: tES effects might be greatest for difficult tasks with more room for improvement [e.g., @Jones2012]. Because this task is more complex than the typical paradigm, tDCS possibly affected other processes such as threat detection or scene perception, and not those underlying visual search per se.
...
pander(tbl_visual_search, split.tables = Inf, justify = 'left',  missing = '',
       split.cells = c(40,1,1,30,5,10,10,8,50),
...
pander(tbl_sustained_attention, split.tables = Inf, justify = 'left',  missing = '',
       split.cells = c(30,1,1,20,5,10,7,25,55),
