...
Theses don't write themselves, and also not by one person.

Worked on this so long (and have grown so old) that it's become increasingly hard to come up with all the list of people I should thank. So I simply won't

-Heleen
- Vanaf de master\ldots{}
- Richard
- Niet intensief samengewerkt, dankzij persoonlijke tegenslagen en omdat je waarschijnlijk zag dat ik bij Heleen in goede handen was. Maar juist je rol op afstand vond ik fijn.
...
\item
  B\&C in general
\item
  Manon/Hubert/Jaap/Ingrid/Lilian: unsung heroes.
\end{itemize}

-Interns?
-TOP (niet onderschatten; extra jaar PhD nodig gehad)
-Participants

-Lynn
- Even if nothing of value came from this PhD, I'd do it all over again, because I wouldn't have met you otherwise.
-Thomas

-Gerard
-Ineke
- Hurts and consoles at the same time to think how proud you would have been that your son wrote a book.
