...
```{r fig-retest, fig.cap='(ref:caption-fig-retest)', results='show', out.width="180mm"}
...
```{r fig-tDCS-corr, fig.cap='(ref:caption-fig-tDCS-corr)', results='show', out.width="130mm"}
