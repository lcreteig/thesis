...
\begin{figure}
\includegraphics[width=130mm]{AB_tDCS_files/figures/figure_3_group} \caption{(ref:caption-fig-group)}(\#fig:fig-group)
\end{figure}
...
\begin{figure}
\includegraphics[width=130mm]{AB_tDCS_files/figures/figure_4_corr} \caption{(ref:caption-fig-corr)}(\#fig:fig-corr)
\end{figure}
...
\begin{figure}
\includegraphics[width=130mm]{AB_tDCS_files/figures/figure_6_estimates} \caption{(ref:caption-fig-rep-estimate)}(\#fig:fig-rep-estimate)
\end{figure}
