...
\vspace*{\fill}
\noindent
_This chapter has been published as_: [Reteig LC, Knapen T, Roelofs FJFW, Ridderinkhof KR, Slagter, HA (2018). No evidence that frontal eye field tDCS affects latency or accuracy of prosaccades. _Frontiers in Neuroscience_ 12:617.](https://doi.org/10.3389/fnins.2018.00617)
\newpage

## Introduction {#sacc_tDCS-introduction}

Transcranial direct current stimulation (tDCS) harbors an exciting promise: it may influence cortical excitability and plasticity [@Yavari2017], yet it is relatively noninvasive and easy to apply. These properties have attracted much attention to the technique, leading to many studies that have used tDCS to better understand the relationship between brain function and behavior [@Filmer2014], to facilitate learning and to enhance cognition [@CohenKadosh2014; @Coffman2014] and even in clinical treatment [@Lefaucheur2016].
...
After task performance was complete, participants filled in a questionnaire on the occurrence of adverse effects related to tDCS (see Figure \@ref(fig:sacc-tDCS-AE) in the [Supplement to this chapter](#sacc_tDCS_supplement)).

### Task

Participants performed a no-gap, no-overlap prosaccade task (Figure \@ref(fig:task)) similar to the task in @Kanai2012, in which they had to make eye movements to a target stimulus. Stimuli were displayed using MATLAB (The MathWorks Inc.) and Psychtoolbox-3 [@Brainard1997; @Pelli1997; @Kleiner2007].
